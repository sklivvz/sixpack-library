...
{
	/// <summary>
	/// Allows to iterate results from a <see cref="Trie{TAtom, TValue}"/>.
	/// </summary>
	/// <typeparam name="TAtom">The type of the atom.</typeparam>
	/// <typeparam name="TValue">The type of the value.</typeparam>
	public interface ITrieEnumerator<TAtom, TValue> : IEnumerator<KeyValuePair<IEnumerable<TAtom>, TValue>>
	{
		/// <summary>
