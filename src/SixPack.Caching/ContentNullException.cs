...
namespace SixPack.Caching
{
	...
	public class ContentNullException: Exception
	{
		...
		public ContentNullException(string message, Exception inner): base(message, inner)
		{
		}
		...
		protected ContentNullException(SerializationInfo info, StreamingContext context): base(info, context)
		{
		}
	}
}